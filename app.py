...
color_info_dict_full = {'보라': {'요약': '독창성과 신비로운 보라',
 ...
 '갈색': {'요약': '침착한 속 싶은 헌신가',
  ...
  '추천 직업': '도서관 사서, 문서 작성가, 출판사 편집자, 고고학자, 간호사, 교사, 공무원, 비서, 사회복지사, 장애인 복지사, 상담사, 요리사, 세무사, 감리사, 농업계 연구원, 가구 디자이너, 현모양처'},
 '검정': {'요약': '조용한 목표 추구형',
...
st.write(f'''
    ...
    .custom-box {{
        ...
        max-width: 100%; /* 박스의 최대 너비를 제한 */
        overflow-wrap: break-word; /* 단어가 너무 길어 줄바꿈이 필요한 경우 단어 내에서도 줄바꿈 */
    }}
    </style>
