...
color_info_dict_full = {'보라': {'요약': '독창성과 신비로운 보라',
  ...
  '추천 직업': '행위예술가, 연극배우, 수필가, 극작가, 시인, 종교인, 상담사, \n치료사, 사진가, 건축가, 실내디자이너, 일러스트레이터, 문학 연구자, 사회학자'},
 '분홍': {'요약': '상냥하며 매력적인 유형',
  ...
  '추천 직업': '예술가, 음악가, 공예가, 마술사, 댄서, 모델, 반려견 사업, 애완견 미용,\n플로리스트, 호텔리어, 카페, 웨딩플래너, 메이크업아티스트, 간호사, 보육교사, \n어린이 관련 직업'},
 '초록': {'요약': '예의바르며 성실한 안정형',
  '성격상 강점': '-예의가 바르고 겸손한 성향.\n-맡겨진 일에 좋은 결과를 노력하지만 자신의 여가도 중요시 함.\n-관계 중심적으로 갈등과 싸움을 싫어해 중립적임.\n-이해와 배려심이 많아 친구들에게 인기가 많으며 친밀한 관계를 형성함.',
  '성격상 약점': '-소극적이며 내성적임.\n-게으른 면이 있을 수 있음.\n-소심해 스트레스를 많이 받음.\n-적극적이고 과감한 상황에 용기 부족.',
  '추천 직업': '공무원, 교사, 공무직, 금융업, 감리사, 세무사, IT개발자, 전문기능인, \n직업상담사, 임상병리사, 재활치료사, 동물훈련사, 1차 산업, 환경운동가, 요식업'},
 '빨강': {'요약': '열정 카리스마 리더형',
  '성격상 강점': '-적극적이고 주도적임.\n-책임감이 강하고 승부욕이 있음\n-확신을 갖는 일에 소신껏 밀어부침.\n-실행력을 동반한 행동파.\n-뒤끝 없으며 과감함.\n-자신감과 자의식이 강함.',
  '성격상 약점': '-성격이 급하고 충동적임.\n-이기적이고 자의식이 강해 자신의 뜻대로 안되면 화가 남.\n-원리원칙에서 벗어날 경우 상대를 불신함.\n-폭발적인 성격으로 감정 다스림이 필요함.',
  '추천 직업': '군인, 경찰, 판사, 검사, 검사, 흉부외과, 정형외과, 마케팅 전문가, \n경영자, 사업가, 창업가, 정치인, 운동선수, 기업가, 모델'},
 '노랑': {'요약': '자존감이 높은 성장 마인드',
  ...
  '추천 직업': '인플루언스, 전문 블로거, 에디터, 잡지, 광고, 언론, 방송인, 기상 캐스터, \n기자, 리포터, 패션 디렉터, 머쳔다이저, 베이커리, 캐릭터 디자인'},
 '주황': {'요약': '활력 넘치는 낙천가 유형',
  ...
  '추천 직업': '연예인, 개그맨, 댄서, 마술사, 메이크업 아티스트, 인터넷 방송인, 응원단, 예술가,\n영업, 마케팅, 세일즈맨, 홍보담당자, 레저활동 전문가, 여행, 숙박업, 스포츠 매니저, 운동선수'},
 '갈색': {'요약': '침착한 속 싶은 헌신가',
  '성격상 강점': '-마음이 따뜻하고 타인에게 도움이 되고 싶어하며 배려하는 성격.\n-마음에 든 사람과 가족에게 헌신함.\n-주어진 일에 책임감과 성실성이 있음.\n-인내와 끈기가 강함.',
  '성격상 약점': '·변화를 싫어하고 느림.\n-타인을 과하게 배려해 손해를 봄.\n-고집스럽고 보수적인 성격.\n-촌스럽거나 답답해 보일 수 있음.\n-변화를 두려워하지말고 도전하는 자세 필요.',
  '추천 직업': '도서관 사서, 문서 작성가, 출판사 편집자, 고고학자, 간호사, 교사, 공무원, 비서,\n사회복지사, 장애인 복지사, 상담사, 요리사, 세무사, 감리사, 농업계 연구원, 가구 디자이너, 현모양처'},
 '검정': {'요약': '조용한 목표 추구형',
 ...
 '파랑': {'요약': '스마트한 논리와 분석형',
  ...
  '추천 직업': '조력가, 교수, 교사, 뇌과학자, 내과의사, 한의사, 연구원, 역사학자, 변호사, 회계사, \n컨설턴트, 금융전문가, 공무원, 엔지니어, 경찰, 출판업, 수필가, 비평가, 물리학자, 수학자, 철학자, 사상가'},
 '하양': {'요약': '다재다능한 완벽 추구형',
  ...
  '추천 직업': '검사, 판사, 법무사, 법학교수, 의사, 약사, 검안관, 보건복지 관련 공무원, \n섬세한 기술의 엔지니어, 공학 기술자, 과학자, 경제학자, 금융전문가, 회계사'}}
