...
color_info_1 = {
    ...
    "하양": ["성실한 책임 완수", "완벽성과 다재다능", "정직과 청렴", "예민, 민감, 스트레스 취약"],
    "노랑": ["진취적인 성향", "밝고 명랑한 관계 지향", "호기심과 탐구심", "질투심, 비판적, 책임감 부족"],
    "주황": ["활발하고 에너지 넘침", "독립적, 자립적, 자유분방", "용감함, 도전적, 추진력", "산만함, 집중력과 인내심 부족"],
    "분홍": ["다정함, 상냥함, 친절함", "섬세하고 감성적, 예술성", "화합, 협조적, 순응적", "불안감, 의존적, 독립심 부족"],
    "빨강": ["열정, 용감, 도전, 자신감", "책임감, 솔직함, 의리", "직설적, 과감함, 다양한 경험", "감정적, 충동성, 분노, 공격성"],
...
color_info_2 = { 
    ...
    "파랑": ["탐구적, 학구적, 지성적", "분석력, 치밀함, 계획성", "책임감, 규칙과 질서", "고독, 우울, 고집, 독단"],
    "갈색": ["안정감과 평온함", "인내, 끈기, 참음", "헌신, 봉사, 내성적, 보수적", "융통성과 이해력 부족, 지루함"],
    "보라": ["신비롭고 매력적, 통찰력", "독착성, 창의, 예술, 자유로움", "독립적, 자존심이 강함", "우월감, 고집, 차별"],
    "검정": ["조용함, 독립성, 내성적", "깊은 생각, 통찰력", "비밀이 많은, 현실적인", "우울, 절망, 고독, 내면을 숨김"]
}       

# DataFrame으로 변환
df_color_2 = pd.DataFrame(color_info_2, index=["1", "2", "3", "4"])
st.table(df_color_2)
